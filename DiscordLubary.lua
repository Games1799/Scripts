...
Discord.Parent = (gethui and gethui()) or (syn and syn.protect_gui and game:GetService("CoreGui")) or (protect_gui and game:GetService("CoreGui")) or (protectgui and game:GetService("CoreGui")) or game:GetService("CoreGui") or (game:GetService("Players").LocalPlayer and game:GetService("Players").LocalPlayer:WaitForChild("PlayerGui"))
	...
	function ServerHold:Server(text, img)
		...
		function ChannelHold:Channel(text)
			...
			function ChannelContent:Label(text)
				...
				LabelFunc.LabelTitle = LabelTitle
				
				function LabelFunc:Change(newText)
                   self.LabelTitle.Text = newText
				   ChannelHolder.CanvasSize = UDim2.new(0,0,0,ChannelHolderLayout.AbsoluteContentSize.Y)
				end
				ChannelHolder.CanvasSize = UDim2.new(0,0,0,ChannelHolderLayout.AbsoluteContentSize.Y)
				return LabelFunc
