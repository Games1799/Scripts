...
r9_0.Parent = gethui() or game:GetService("CoreGui")
...
function r12_0.NewWindow(r0_10, r1_10, ...)
 ...
 r4_19.Position = UDim2.new(0,052941177, 0, 0)
 ...
 r5_19.Прозрачность фона = 1
 r5_19.Размер пикселя границ = 0
 r5_19.Position = UDim2.new(0.847058833, 0, 0.166666672, 0)
 r5_19.Размер = UDim2.новый(0, 20, 0, 20)
 ...
 r8_23.Name = «Заголовок слайдера»
 r8_23.Parent = r7_23
 r8_23.BackgroundColor3 = Color3.new(1, 1, 1)
 r8_23.Прозрачность фона = 1
 r8_23.Размер пикселя границ = 0
 ...
 r12_23.Размер = UDim2.new(((r4_23 или r2_23) - r2_23) / (r3_23 - r2_23), 0, 0, 5)
 r12_23.Изображение = "rbxassetid://3570695787"
 r12_23.Тип масштабирования = Enum.Тип масштабирования. Срез
